...
5. Los estados musicales cruzan ganancia durante 1.5 s, bajan con radio o pausa y no reinician pista.
6. Al desmontar la aplicación se detienen bucles, se liberan buffers y se cierra el contexto. Un
